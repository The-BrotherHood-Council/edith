...
from edith import BOT_ID, BOT_NAME, BOT_USERNAME, dispatcher
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        url = f"https://kora-api.vercel.app/chatbot/2d94e37d-937f-4d28-9196-bd5552cac68b/{BOT_NAME}/HUNTER/message={message.text}"
...
☆............𝙱𝚈 » [DARKK HUNTERR](https://t.me/HUNTER_IS_BACK)............☆
"""
