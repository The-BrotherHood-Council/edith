...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/THE_BROTHERHOOD_COUNCIL"),
    ],
    [
        InlineKeyboardButton(text="🌱𝐒𝐎𝐔𝐑𝐂𝐄🌱", callback_data="edith_"),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://github.com/the-brotherhood-council-OP/edith",
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="✯ вαϲк ✯", callback_data="edith_back"),
                    ],
                ]
            ),
        )
...
""",
    ...
    about_callback_handler = CallbackQueryHandler(
        edith_about_callback, pattern=r"edith_"
    )
